...
- [x] ISC-132: A source whose own frame counter cannot be laid out on the recording is still recorded, rather than costing the meeting it was part of.
...
- **criterion-now** — A counter that goes back on itself is given up on rather than refused, and
  ...
  clock and so survives the counter being replaced.
