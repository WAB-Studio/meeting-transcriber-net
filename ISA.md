...
- [ ] ISC-164: Anti: a question this machine has not come back from stops no other question about its devices being asked, so a meeting following a microphone that went away is never held up by a screen looking at what the machine plays through.
