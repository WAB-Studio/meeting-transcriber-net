...
- [x] ISC-73.2: Anti: a silent stretch is there rather than missing, however another application is using the speakers the meeting is coming out of.
...
- [x] ISC-120: A recording says in its own folder what fed each of its channels: which device, which program, or that it was everything the machine plays.
